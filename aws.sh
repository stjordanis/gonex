...
GETH="./geth-linux-amd64 --verbosity=5 --syncmode full --networkid $NETWORK_ID --rpc --rpcapi db,eth,net,web3,personal --rpccorsdomain \"*\" --rpcaddr 0.0.0.0 --gasprice 0 --targetgaslimit 42000000 --txpool.pricelimit 0 --txpool.accountslots 16 --txpool.globalslots 4096 --txpool.accountqueue 64 --txpool.globalqueue 1024 --gcmode=archive"
